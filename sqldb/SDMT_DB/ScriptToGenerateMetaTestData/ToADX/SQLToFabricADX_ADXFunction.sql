...
DECLARE  @LowWaterMark     DATE         = '2021-11-25'   -- GE
        ...
        ,@SourceSystemName sysname      = 'SQLToFabricADX_ADXFunction'
...
WHERE  SourceSystemName  = 'SQLToFabricADX_ADXFunction'
...
DECLARE  @LowWaterMark     DATE         = '2021-11-25'   -- GE
        ,@HigWaterMark     DATE         = '2021-11-28'   -- LT   
        ,@Resolution       VARCHAR(25)  = 'Day'   -- Day/Month
        ,@SourceSystemName sysname      = 'SQLToFabricADX_ADXFunctionFullWhere'
...
SELECT *
FROM   [Mart].[SlicedImportObject]
WHERE  SourceSystemName  = 'SQLToFabricADX_ADXFunctionFullWhere'
